...
void Lab2::Init()
{
    ...
    // by definition!
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(4, 0,  0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),

            VertexFormat(glm::vec3(2, 0,  4), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2, 0,  4), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2, 0,  4), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),

            VertexFormat(glm::vec3(2, 2,  2), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2, 2,  2), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2, 2,  2), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6))
        };

        vector<unsigned int> indices =
        {
            0, 3, 6,    // indices for first triangle
            1, 4, 10,    // indices for second triangle
            // TODO(student): Complete indices data for the cube mesh
            8, 2, 11,
            3, 6, 9,
        };
        ...
        // Actually create the mesh from the data
        CreateMesh("thetra", vertices, indices);
    }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(3, 1, 3), glm::vec3(0.75f));
    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["thetra"], shaders["VertexColor"], glm::vec3(5, 2, 5), glm::vec3(0.75f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(1, 2, 1), glm::vec3(0.75f));

    RenderMesh(meshes["thetra"], shaders["VertexColor"], glm::vec3(-4, 1, -4), glm::vec3(0.75f));
