...
void Lab3::Init()
{
    ...
    this->maximRight= false;
    this->maximLeft = true;
    this->maxScale = false;
    this->minScale = true;
    this->rightUpMax = false;
    this->rightDownMax = true;
    this->angle = 0;
    this->rotatingPoint = 100;
    ...
    Mesh* square4 = object2D::CreateSquare("square4", corner, squareSide, glm::vec3(1, 0, 1), true);
...
void Lab3::Update(float deltaTimeSeconds)
{
    ...
    modelMatrix = glm::mat3(1);
    modelMatrix *= transform2D::Translate(450, 50);
    modelMatrix *= transform2D::Translate(cx + rotatingPoint, cy);
