    ...
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::vec4 newForward = glm::vec4(forward, 1) * glm::rotate(glm::mat4(1.0f), angle, right);
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::vec4 newForward = glm::vec4(forward, 1) * glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0));
            forward = glm::normalize(glm::vec3(newForward));
            glm::vec4 newRight = glm::vec4(right, 1) * glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0));
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::vec4 newRight = glm::vec4(right, 1) * glm::rotate(glm::mat4(1.0f), angle, forward);
            right = glm::normalize(glm::vec3(newRight));
            up = glm::normalize(glm::cross(right, forward));
